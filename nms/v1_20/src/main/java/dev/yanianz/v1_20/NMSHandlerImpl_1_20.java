...
/**
 * Real NMS adapter for Paper 1.20.0 – 1.20.1. Predates the 1.21.2 SlotDisplay API and the 1.20.5
 ...
 */
public final class NMSHandlerImpl_1_20 implements NMSHandler {
    ...
    public void sendGhostRecipe(PlayerRecipeBookClickEvent event, Config config, MinionManager minionManager,
        ...
        try {
            NMSHandlerImpl_1_20_LegacyGhostRecipeSender.send((CraftPlayer) player, key);
