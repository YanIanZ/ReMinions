...
/** Adapter group for Paper builds in the 1.20.0 – 1.20.1 range. Delegates to the shared API-only impl. */
public final class NMSHandlerImpl_v1_20 implements NMSHandler {
