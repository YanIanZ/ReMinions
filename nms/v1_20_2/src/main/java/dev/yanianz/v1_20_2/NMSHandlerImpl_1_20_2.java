...
/**
 * Real NMS adapter for Paper 1.20.2. Predates the 1.21.2 SlotDisplay API and the 1.20.5
 ...
 */
public final class NMSHandlerImpl_1_20_2 implements NMSHandler {
    ...
    public void sendGhostRecipe(PlayerRecipeBookClickEvent event, Config config, MinionManager minionManager,
        ...
        try {
            NMSHandlerImpl_1_20_2_LegacyGhostRecipeSender.send((CraftPlayer) player, key);
