...
/**
 * Real NMS adapter for Paper 1.21.0 - 1.21.1. Predates the 1.21.2 SlotDisplay API, so the ghost recipe
 ...
 */
public final class NMSHandlerImpl_1_21 implements NMSHandler {
    ...
    public void sendGhostRecipe(PlayerRecipeBookClickEvent event, Config config, MinionManager minionManager,
        ...
        try {
            NMSHandlerImpl_1_21_LegacyGhostRecipeSender.send((CraftPlayer) event.getPlayer(), key);
