...
public class NMSHandlerImpl_1_20_1 implements NMSHandler {
   @Override
   public void sendGhostRecipe(PlayerRecipeBookClickEvent e, Config config, MinionManager minionManager, Recipe recipe, ItemStack resultItem) {
      ...
      MinecraftKey var32 = CraftNamespacedKey.toMinecraft(((ShapedRecipe)recipe).getKey());
      ShapedRecipes var34 = new ShapedRecipes(var32, var7.getGroup(), CraftRecipe.getCategory(var7.getCategory()), var29, var7.getShape().length, var30, var28);
      EntityPlayer var36 = ((CraftPlayer)var6).getHandle();
      int var37 = var36.bR.j;
      var36.c.a(new PacketPlayOutAutoRecipe(var37, var34));
   }
